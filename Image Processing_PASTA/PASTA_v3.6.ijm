...
/* PArticle Shapes and Textures Analyzer (PASTA) v3.6 (August 8, 2020)
...
segLabel = "_ftseg";
	...
	print("Processing Crystallinity - Vesicularity");
					...
					"\n \nPress Ok to start.");
						...
						manuScroll = 0;
						atscroll = 0; // Default check of inactive autoscroll
							...
							while (trsel == false) { // Stay on image thresholding until the exit check is ticked
								 ...
								 */
									if (snglImgPro == 0) {
										...
										if (advscrol == true) {
											atscroll = 1; // check if autoscroll is active and keep it until changes
