...
/* PArticle Shapes and Textures Analyzer (PASTA) v3.3 (May 20, 2020)
				...
				for (isg = 0; isg < pickList.length; isg++) {
					...
					open(myDir1+File.separator+pickList[isg]);
						...
						*/
						...
						//print("groundmass: "+ gfo, "; vesicles?: "+ gfv, "; Crystals?:"+ gfc);
						//waitForUser("are greyscale changing?");
						run("Select None");
						resetThreshold;
...
if (rbut3a == "Particle shapes" || "Both") {
...
if (rbut3a == "Crystallinity - Vesicularity		" || "Both") {	
