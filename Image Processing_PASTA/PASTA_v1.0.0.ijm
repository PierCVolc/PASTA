/*
 * IMPORTANT NOTE: The macro processes one or multiple input image files at the same time, 
 * with the latter having the same background color (inter-particle area).
*/
